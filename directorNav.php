...
<nav class="navbar navbar-expand-lg brown_panel">
  <a class="navbar-brand" href="director.php">Личный кабинет директора</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-4">
      <li class="nav-item">
        <a class="nav-link" href="director.php">Общие отчеты</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="masterReports.php">Объем работы мастеров</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="serviceReports.php">Объем оказанных услуг</a>
      </li>
